...
public class SecurityConfig extends WebSecurityConfigurerAdapter{
	...
	private final JwtTokenProvider jwtTokenProvicer;
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		.authenticated()
		.and()
		.addFilterBefore(new JwtAuthenticationFilter(jwtTokenProvicer), UsernamePasswordAuthenticationFilter.class)
		.exceptionHandling()
